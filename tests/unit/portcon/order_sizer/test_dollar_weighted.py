...
@pytest.mark.parametrize(
    ...
    [(-1.0, None), (0.0, 0.0), (0.5, 0.5), (0.99, 0.99), (1.0, 1.0), (1.5, None)],
)
...
@pytest.mark.parametrize(
    "weights,expected",
    [
        ({"EQ:ABC": 0.2, "EQ:DEF": 0.6}, {"EQ:ABC": 0.25, "EQ:DEF": 0.75}),
        ({"EQ:ABC": 0.5, "EQ:DEF": 0.5}, {"EQ:ABC": 0.5, "EQ:DEF": 0.5}),
        ({"EQ:ABC": 0.01, "EQ:DEF": 0.01}, {"EQ:ABC": 0.5, "EQ:DEF": 0.5}),
        (
        ...
        ({"EQ:ABC": 0.0, "EQ:DEF": 0.0}, {"EQ:ABC": 0.0, "EQ:DEF": 0.0}),
        ({"EQ:ABC": -0.2, "EQ:DEF": 0.6}, None),
    ],
)
