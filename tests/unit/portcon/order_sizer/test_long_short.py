...
@pytest.mark.parametrize(
    ...
    [
        ({"EQ:ABC": 0.2, "EQ:DEF": 0.6}, 1.0, {"EQ:ABC": 0.25, "EQ:DEF": 0.75}),
        ({"EQ:ABC": 0.5, "EQ:DEF": 0.5}, 1.0, {"EQ:ABC": 0.5, "EQ:DEF": 0.5}),
        ({"EQ:ABC": 0.01, "EQ:DEF": 0.01}, 1.0, {"EQ:ABC": 0.5, "EQ:DEF": 0.5}),
        ({"EQ:ABC": 0.2, "EQ:DEF": 0.6}, 2.0, {"EQ:ABC": 0.5, "EQ:DEF": 1.5}),
        ({"EQ:ABC": 0.2, "EQ:DEF": 0.6}, 0.5, {"EQ:ABC": 0.125, "EQ:DEF": 0.375}),
        (
        ...
        ({"EQ:ABC": 0.0, "EQ:DEF": 0.0}, 1.0, {"EQ:ABC": 0.0, "EQ:DEF": 0.0}),
        ({"EQ:ABC": -0.2, "EQ:DEF": 0.6}, 1.0, {"EQ:ABC": -0.25, "EQ:DEF": 0.75}),
        ({"EQ:ABC": -0.2, "EQ:DEF": 0.6}, 2.0, {"EQ:ABC": -0.5, "EQ:DEF": 1.5}),
        (
            {"EQ:ABC": -0.1, "EQ:DEF": 0.3, "EQ:GHI": 0.02, "EQ:JKL": -0.8},
...
def test_call(total_equity, gross_leverage, weights, asset_prices, expected):
    ...
    data_handler = Mock()
    data_handler.get_asset_latest_ask_price.side_effect = lambda self, x: asset_prices[
        x
    ]
