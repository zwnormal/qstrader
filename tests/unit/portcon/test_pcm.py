...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            {"EQ:ABC": 100, "EQ:DEF": 250, "EQ:GHI": 38},
...
def test_obtain_full_asset_list(description, port_dict, uni_assets, expected):
    ...
    pcm = PortfolioConstructionModel(broker, port_id, universe, order_sizer, optimiser)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            {"EQ:ABC": {"quantity": 100}, "EQ:DEF": {"quantity": 250}},
            {},
            [Order(SENTINEL_DT, "EQ:ABC", 100), Order(SENTINEL_DT, "EQ:DEF", 250)],
        ),
        (
            "empty target portfolio with non-empty current portfolio",
            {},
            {"EQ:ABC": {"quantity": 345}, "EQ:DEF": {"quantity": 223}},
            [Order(SENTINEL_DT, "EQ:ABC", -345), Order(SENTINEL_DT, "EQ:DEF", -250)],
        ),
        (
        ...
        (
            ...
            [Order(SENTINEL_DT, "EQ:ABC", -94), Order(SENTINEL_DT, "EQ:DEF", 408)],
        ),
    ],
)
def test_generate_rebalance_orders(
    ...
    result = pcm._generate_rebalance_orders(
        SENTINEL_DT, target_portfolio, current_portfolio
    )
